...
/**
 * SECTION:search-result-meta
 * @short_description: Information about a search result
 * @Title: PhoshSearchResultMeta
 *
 * A #PhoshSearchResultMeta is a low level immutable representation of a
 * search result
 *
 ...
 * @self: the #PhoshSearchResultMeta
 *
...
{
  PhoshSearchResultMeta *self;

  self = g_rc_box_new0 (PhoshSearchResultMeta);
  self->id = g_strdup (id);
 ...
 * @self: the #PhoshSearchResultMeta
 *
 * Generate a #GVariant representation of @self suitable for transpor over
